...
char *copieFinChaine (char *c1, char *c2, char *c3) { /*c1 = chaîne 1, c2 = chaîne 2, chaîne destinataire.*/
...
char *copieDebutChaine (char *c2, char *c1, char *c3) { /*c2 = chaîne 1, c1 = chaîne 2, chaîne destinataire.*/
	int i=0, j=0; //j : variable de boucle c2.
...
char *coupeStr (char *c1, char *c2, int x, int y) { /* on coupe le string de x à y inclu.*/
